...
function display() {
    for (let element of goods) {
        let phone = document.createElement("div");
        phone.className = "phoneblock";
        let image = document.createElement("img");
        image.className = "phone_img"
        image.src = "images/phone.jpg";
        let imagediv = document.createElement("div");
        imagediv.className = "imageblock";
        imagediv.appendChild(image);
        phone.appendChild(imagediv);
        let rating = document.createElement("p");
        rating.className = "rating";
        rating.textContent = element.ratingRevievs;
        phone.appendChild(rating);
        let name = document.createElement("p");
        name.className = "name";
        name.textContent = element.name;
        phone.appendChild(name);
        if (element.price.newUan === undefined) {
            ...
            oldPrice.className = "oldprice";s   d  sss
            newPrice.className = "newprice";
            oldPrice.textContent = element.price.oldUan;
            newPrice.textContent = element.price.newUan;
            phone.appendChild(oldPrice);
            phone.appendChild(newPrice);
        }
